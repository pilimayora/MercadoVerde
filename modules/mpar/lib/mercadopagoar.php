...
$GLOBALS["LIB_LOCATION_AR"] = dirname(__FILE__);
...
class MercadoPagoAR {
    ...
    public function get_access_token() {
        ...
        $access_data = MPRestClientAr::post("/oauth/token", $appClientValues, "application/x-www-form-urlencoded");
    ...
    public function get_payment_info($id) {
        ...
        $paymentInfo = MPRestClientAr::get($uriPrefix."/collections/notifications/" . $id . "?access_token=" . $accessToken);
        return $paymentInfo;
    }
    ...
    public function refund_payment($id) {
        ...
        $response = MPRestClientAr::put("/collections/" . $id . "?access_token=" . $accessToken, $refund_status);
        return $response;
    }
    ...
    public function cancel_payment($id) {
        ...
        $response = MPRestClientAr::put("/collections/" . $id . "?access_token=" . $accessToken, $cancel_status);
        return $response;
    }
    ...
    public function search_payment($filters, $offset = 0, $limit = 0) {
        ...
        $collectionResult = MPRestClientAr::get($uriPrefix."/collections/search?" . $filters . "&access_token=" . $accessToken);
    ...
    public function create_preference($preference) {
        ...
        $preferenceResult = MPRestClientAr::post("/checkout/preferences?access_token=" . $accessToken, $preference);
    ...
    public function update_preference($id, $preference) {
        ...
        $preferenceResult = MPRestClientAr::put("/checkout/preferences/{$id}?access_token=" . $accessToken, $preference);
        return $preferenceResult;
    }
    ...
    public function get_preference($id) {
        ...
        $preferenceResult = MPRestClientAr::get("/checkout/preferences/{$id}?access_token=" . $accessToken);
        return $preferenceResult;
    }
...
class MPRestClientAr {
    ...
    private static function getConnect($uri, $method, $contentType) {
        ...
        curl_setopt($connect, CURLOPT_USERAGENT, "MercadoPago PHP SDK v" . MercadoPagoAR::version);
        curl_setopt($connect, CURLOPT_CAINFO, $GLOBALS["LIB_LOCATION_AR"] . "/cacert.pem");
