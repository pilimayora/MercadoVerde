...
class MyBlockCart extends Module
{
	public function __construct()
	{
		$this->name = 'myblockcart';
		...
		$this->displayName = $this->l('My Cart block');
		$this->description = $this->l('Carrito modificado por Pili');
	...
	public function hookRightColumn($params)
	{
		...
		return $this->display(__FILE__, 'myblockcart.tpl');
	}
	...
	public function hookAjaxCall($params)
	{
		...
		$this->assignContentVars($params);
		$res = Tools::jsonDecode($this->display(__FILE__, 'myblockcart-json.tpl'), true);
	...
	public function hookActionCartListOverride($params)
	{
		...
		$params['json'] = $this->display(__FILE__, 'myblockcart-json.tpl');
	}
	...
	public function hookHeader()
	{
		...
		$this->context->controller->addCSS(($this->_path).'myblockcart.css', 'all');
