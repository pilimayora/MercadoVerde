...
{if {$seller} == 1}
 ...
 <input type="button" value="Customers Queries" onclick="window.location.href='{$customer_queries_link}&seller_id={$seller_id}'">
 <input type="button" value="My Queries" onclick="window.location.href='{$link->getModuleLink('marketplace', 'my_queries')}'">
 </div>
{/if}
</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var base_url = url+'index.php?fc=module&module=marketplace&controller=enquiry_desc&id='+id;
