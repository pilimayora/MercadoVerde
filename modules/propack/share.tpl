...
{if $propackfbrefon == 1 && $propack_psextraRightf == "psextraRightf"}
...
{if $propacktwrefon == 1 && $propack_psextraRightt == "psextraRightt"}
				<!-- twitter referrals -->
				<div style="display:block; text-align:center; clear:both;">
...
{if $propackgrefon == 1 && $propack_psextraRightg == "psextraRightg"}
				<!-- google referrals -->
...
{if $propacklrefon == 1 && $propackis_l==1 && $propack_psextraRightl == "psextraRightl"}
				{literal}
...
{$propackextrarightsnippet}


{if $propackpinvis_on == 1 && $propack_extraRight == 'extraRight' 
...
{if $propackposition_ask_q == 'extraright' && $propackcontent_only == 0}
<a class="blueBtn" 
