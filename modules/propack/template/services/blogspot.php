	...
	<tr>
		<td style="padding:10px">
			<form action="<?php echo $host ?>modules/propack/login.php?p=login" method="post">
			    <input type="hidden" name="service_url" value="blogspot.com"/>
			    <b><h2 style="color:#0A263C">Blogger Authorization</h2></b><br/>
			    <input type="text" name="openid_identifier" value="" class="input-text"/><br/>
			    <i style="color:#2F2F2F;">Your Blogger username</i><br/>
