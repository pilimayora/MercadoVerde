...
<div style="margin:20px 0px;text-align: left;padding-left:30%">
	...
	{if $propackfbrefshareon == 1 && $propackfbrefon == 1}
	...
	{if $propacktwrefshareon == 1 && $propacktwrefon == 1}
	<!-- twitter referrals -->
				<div style="display:block; text-align:center; clear:both;">
                    <div class="twitter_share float-left">
                		...
                		<div class="twitter_share_bg float-left">
                			<span>
                				...
                				<a href="https://twitter.com/intent/tweet?url={$propackurl}&amp;text={$propackstoredesc}" 
	...
	{if $propackgrefshareon == 1 && $propackgrefon == 1}
				<!-- google referrals -->
	...
	{if $propacklrefshareon == 1 && $propacklrefon == 1 && $propackis_l==1}
	{literal}
