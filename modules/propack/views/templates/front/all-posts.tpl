...
<h2 class="background-none">{$meta_title}</h2>
{else}
...
<div class="clear"></div>
<h3 class="float-right">Results for "{$propacksearch}"</h3>
<div class="clear"></div>
{/if}
		...
		<ul class="sorter">
			<li>
				<span>
					...
					<a href="{$base_dir}modules/propack/rss.php" title="{l s='RSS Feed' mod='propack'}" target="_blank">
						<img src="{$base_dir}modules/propack/i/feed.png" alt="{l s='RSS Feed' mod='propack'}" />
					</a>
				</span>
			</li>
