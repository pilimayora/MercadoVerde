				...
				{if $review.rating != 0}
					{section name=ratid loop=5}
						{if $smarty.section.ratid.index < $review.rating} 
							<img src="{$base_dir}modules/propack/images/ico-star.png" class="gsniprev-img-star" alt="{$smarty.section.ratid.index}"/>
						{else}
							<img src="{$base_dir}modules/propack/images/ico-star-grey.png" class="gsniprev-img-star" alt="{$smarty.section.ratid.index}"/>
						{/if}
					{/section}
				{else}
					&nbsp;
