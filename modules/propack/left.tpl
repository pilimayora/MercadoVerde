...
{if $propack_leftcolumnf == "leftcolumnf" || $propack_leftcolumng == "leftcolumng" 
	...
	|| $propack_leftcolumnm == "leftcolumnm" || $propack_leftcolumnc == "leftcolumnc"
...
{if $propackfaq_left == 1}
	...
	<div id="blockfaq_block_left" class="block {if $propackis16 == 1}blockmanufacturer16{else}blockmanufacturer{/if}" id="manufacturers_block_left">
...
{if $propackg_left == 1}
	...
	<div id="blockg_block_left" class="block blockmanufacturer {if $propackis16 == 1}blockguestbook-block16{/if}" id="manufacturers_block_left">
...
{if $propacknews_left == 1}
	...
	<div id="blocknews_block_left" class="block {if $propackis16 == 1}blockmanufacturer16{else}blockmanufacturer{/if}" id="manufacturers_block_left">
		<h4 class="title_block" align="center">
		{if $propackurlrewrite_on == 1}
